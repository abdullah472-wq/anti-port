...
export default function TechHero() {
  ...
  mission: "Building impact with clean code"
        ...
        <MagneticButton distance={0.3}>
          <button className="px-8 py-3 bg-gradient-to-r from-primary to-secondary text-white rounded-xl font-medium hover:shadow-glow-primary transition-all duration-300">
            Initialize Project
          </button>
        </MagneticButton>
      </div>
